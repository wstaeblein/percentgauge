    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 64, 12, 2194);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 59, 4, 2009);
    			attr_dev(span, "class", "display svelte-dngx7s");
    			add_location(span, file$1, 62, 8, 2111);
    			attr_dev(div1, "class", "title svelte-dngx7s");
    			add_location(div1, file$1, 61, 4, 2065);
    			attr_dev(div2, "class", "container svelte-dngx7s");
    			add_location(div2, file$1, 58, 0, 1958);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function update() {
    		...
    		if (gauge && container) {
    			...
    			$$invalidate(3, showVal = (+showVal).toLocaleString());
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Percentgauge> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br5 = element("br");
    			br6 = element("br");
    			attr_dev(h1, "class", "svelte-1d6coaa");
    			add_location(h1, file, 27, 8, 562);
    			attr_dev(p0, "class", "svelte-1d6coaa");
    			add_location(p0, file, 28, 8, 593);
    			add_location(div0, file, 26, 4, 548);
    			attr_dev(div1, "class", "gauge svelte-1d6coaa");
    			...
    			attr_dev(div2, "class", "checks svelte-1d6coaa");
